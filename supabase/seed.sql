...
INSERT INTO lots (id, name, area, center, total_spaces, accessible_spaces, ev_spaces, motorcycle_spaces, walk_times, has_covered_parking, has_ev_charging, has_lighting, image_url, notes)
VALUES
  -- Commuter Lot C1 (West of Jones AT&T Stadium)
  (
    'C1',
    'Commuter Lot C1',
    'west',
    ...
    TRUE,
    NULL,
    'Largest commuter lot, near stadium. Very busy on game days.'
  ),

  -- Commuter Lot C4 (Southwest campus)
  (
    'C4',
    'Commuter Lot C4',
    'west',
    ...
    TRUE,
    NULL,
    'Near Rec Center and United Supermarkets Arena'
  ),

  -- Commuter Lot C11 (North campus, near Flint Ave)
  (
    'C11',
    'Commuter Lot C11',
    'north',
  ...
  -- Commuter Lot C12 (Near Law School)
  (
    'C12',
    'Commuter Lot C12',
    'north',
    ...
    TRUE,
    NULL,
    'Near Law School and Rawls College of Business'
  ),

  -- Commuter Lot C14 (East campus)
  (
    'C14',
    'Commuter Lot C14',
    'east',
    ...
    TRUE,
    NULL,
    'Has EV charging stations. Near Business buildings.'
  ),

  -- Commuter Lot C15 (Near Chitwood/Weymouth)
  (
    'C15',
    'Commuter Lot C15',
    'central',
    ...
    TRUE,
    NULL,
    'Central location, fills up quickly'
  ),

  -- Commuter Lot C16 (Near Human Sciences)
  (
    'C16',
    'Commuter Lot C16',
    'central',
    ...
    TRUE,
    NULL,
    'Good central access, moderate walk to most buildings'
  ),

  -- Surface Lot S1 (Near Urbanovsky Park)
  (
    'S1',
    'Surface Lot S1',
    'south',
    ...
    TRUE,
    NULL,
    'Near Rec Center, good for athletics facilities'
  )
...
VALUES
  ...
  -- After hours - any commuter permit
  ('C1', 'commuter_west', '17:30', '23:59', '{1,2,3,4,5}', 'After hours - open to all commuters'),
  ('C1', 'commuter_west', '00:00', '07:30', '{1,2,3,4,5}', 'Before hours - open to all commuters'),

  -- Weekends - open to all
  ('C1', 'commuter_west', '00:00', '23:59', '{0,6}', 'Weekend - open access'),
  ('C4', 'commuter_west', '00:00', '23:59', '{0,6}', 'Weekend - open access'),
  ('C11', 'commuter_west', '00:00', '23:59', '{0,6}', 'Weekend - open access'),
  ('C12', 'commuter_west', '00:00', '23:59', '{0,6}', 'Weekend - open access'),
  ('C14', 'commuter_west', '00:00', '23:59', '{0,6}', 'Weekend - open access'),
  ('C15', 'commuter_west', '00:00', '23:59', '{0,6}', 'Weekend - open access'),
  ('C16', 'commuter_west', '00:00', '23:59', '{0,6}', 'Weekend - open access'),
  ('S1', 'commuter_west', '00:00', '23:59', '{0,6}', 'Weekend - open access')
...
-- Accessible permits - all lots, all times
INSERT INTO permit_rules (lot_id, permit_type, valid_from, valid_until, valid_days, notes)
VALUES
  ('C1', 'accessible', '00:00', '23:59', '{0,1,2,3,4,5,6}', 'Accessible parking - designated spaces only'),
  ('C4', 'accessible', '00:00', '23:59', '{0,1,2,3,4,5,6}', 'Accessible parking - designated spaces only'),
  ('C11', 'accessible', '00:00', '23:59', '{0,1,2,3,4,5,6}', 'Accessible parking - designated spaces only'),
  ('C12', 'accessible', '00:00', '23:59', '{0,1,2,3,4,5,6}', 'Accessible parking - designated spaces only'),
  ('C14', 'accessible', '00:00', '23:59', '{0,1,2,3,4,5,6}', 'Accessible parking - designated spaces only'),
  ('C15', 'accessible', '00:00', '23:59', '{0,1,2,3,4,5,6}', 'Accessible parking - designated spaces only'),
  ('C16', 'accessible', '00:00', '23:59', '{0,1,2,3,4,5,6}', 'Accessible parking - designated spaces only'),
  ('S1', 'accessible', '00:00', '23:59', '{0,1,2,3,4,5,6}', 'Accessible parking - designated spaces only')
ON CONFLICT (lot_id, permit_type) DO UPDATE SET
  valid_from = EXCLUDED.valid_from,
  valid_until = EXCLUDED.valid_until,
  valid_days = EXCLUDED.valid_days,
...
INSERT INTO events (name, event_type, starts_at, ends_at, affected_lot_ids, impact_level, description, venue, expected_attendance, arrival_recommendation, alternative_lots)
VALUES
  (
    'TTU vs OU Football',
    'football',
